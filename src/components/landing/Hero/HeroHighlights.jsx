...
export function HeroHighlights() {
    ...
    return (<dl className="hero-highlights mt-8 grid grid-cols-1 gap-3 min-[300px]:grid-cols-2 sm:mt-10 sm:grid-cols-4">
